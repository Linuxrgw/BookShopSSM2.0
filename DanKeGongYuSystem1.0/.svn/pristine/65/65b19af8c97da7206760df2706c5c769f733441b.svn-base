 ...
 * @Description:发送验证码
 * @author rgw
 * @createTime 2018年10月26日下午2:29:23
 */
public class GetMessageCode {
	private static final String QUERY_PATH="https://api.miaodiyun.com/20150822/industrySMS/sendSMS";
	private static final String ACCOUNT_SID="bfecae2622f3429d88d509142ef6b9a2";
	//private static final String ACCOUNT_SID="bfecae2622f3429d88d509142ef6b9a2";
	private static final String AUTH_TOKEN="41e3a5690d5f44aebfa6d03f2ba53161";
	...
	public static String getCode(String phone){
		...
		String tamp="【蛋壳公寓】登录验证码："+rod+"，如非本人操作，请忽略此短信。";
