...
<table align="center" width="90%">
  ...
  <tr>
     <td align="center">
     <a href="${pageContext.request.contextPath}/AllBookBackSvl">图书列表</a>&nbsp;
     <a href="#">新书上架</a>&nbsp;
     <a href="#">书增加库存</a>&nbsp;
     <a href="#">书下架</a>&nbsp;
     <a href="#">用户管理</a>&nbsp;
  ...
  <tr>
     <td>
        <form action="${pageContext.request.contextPath}/addBook.action" method="post" enctype="multipart/form-data" onsubmit="return validName()">
            <table border="0" align="center" width="60%">
               ...
               <tr> 
                <td>出版日期</td>
                <td><input class="easyui-datebox" name="pubdate" type="text" value="08/20/2018"/></td>   
               </tr>
               ...
               <tr> 
                <td>图片上传</td>
                <td><input type="file" name="imgpath1" /></td>   
               </tr>
